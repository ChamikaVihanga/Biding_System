...
namespace SampleBid2.Controllers
{
    public class ManagersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ManagerName,Address,ContectNo")] Manager manager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ManagerName,Address,ContectNo")] Manager manager)
        {
            if (id != manager.Id)
            {
                return NotFound();
